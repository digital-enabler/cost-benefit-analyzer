  ...
  setup(props) {
    ...
    const chartData = computed(() => {
      ...
      const colorPalette = [
        '#ff0000', // Bright Red
        '#8b0000', // Dark Red
        // Following colors are chosen to be distinct from each other and the initial reds
        '#00B3E6', '#FFB399', '#FF33FF', '#FFFF99', '#E6B333',
        '#3366E6', '#999966', '#99FF99', '#B34D4D', '#80B300',
        '#809900', '#6680B3', '#66991A', '#FF99E6', '#CCFF1A',
        '#FF1A66', '#FF6633', '#33FFCC', '#66994D', '#B366CC',
